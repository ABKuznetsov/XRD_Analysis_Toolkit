...
class WindowsFileAssociationTests(unittest.TestCase):
    ...
    def test_incomplete_runtime_can_be_updated_or_completed_from_error_dialog(self) -> None:
        ...
        self.assertIn("Update or complete installation", self.runtime_setup_ui)
        ...
        self.assertIn("Retry", self.runtime_setup_ui)
        self.assertIn("Open log", self.runtime_setup_ui)
        self.assertIn("Close", self.runtime_setup_ui)
