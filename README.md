...
**Windows 10/11:** [Download `XRD_Phase_Finder_Setup_1.3.2.exe`](https://github.com/ABKuznetsov/XRD_Analysis_Toolkit/releases/download/v1.3.2/XRD_Phase_Finder_Setup_1.3.2.exe) and run the installer.
...
# XRD Phase Finder 1.3.2

Multi-pattern publication update with collision-aware per-pattern legends, manual positioning and improved high-resolution export.
...
- Windows 10/11: [XRD_Phase_Finder_Setup_1.3.2.exe](https://github.com/ABKuznetsov/XRD_Analysis_Toolkit/releases/download/v1.3.2/XRD_Phase_Finder_Setup_1.3.2.exe)
...
```text
XRD_Phase_Finder_Setup_1.3.2.exe
```
