...
**Windows 10/11:** [Download `XRD_Phase_Finder_Setup_1.4.0.exe`](https://github.com/ABKuznetsov/XRD_Analysis_Toolkit/releases/download/v1.4.0/XRD_Phase_Finder_Setup_1.4.0.exe) and run the installer.
...
- Windows 10/11: [XRD_Phase_Finder_Setup_1.4.0.exe](https://github.com/ABKuznetsov/XRD_Analysis_Toolkit/releases/download/v1.4.0/XRD_Phase_Finder_Setup_1.4.0.exe)
...
```text
XRD_Phase_Finder_Setup_1.4.0.exe
```
